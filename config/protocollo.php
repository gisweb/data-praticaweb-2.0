...
define('SERVICE_PASSWD','Sportello2019!');
...
define('WS_URL_PROT','http://51.77.117.13:8079/portale_demo/iol_praticaweb/protocolla_comunicazione');
//define('WS_URL_PROT','https://demo.istanze-online.it/iol_praticaweb/protocolla_comunicazione');
