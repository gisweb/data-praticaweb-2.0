<?php
define('NOME_COMUNE','Comune di Sanremo Vigilanza - Pratiche Edilizie');//nome completo del comune che compare nell'intestazione
...
if (!defined("DB_NAME")) define('DB_NAME','gw_sanremo_demo');
