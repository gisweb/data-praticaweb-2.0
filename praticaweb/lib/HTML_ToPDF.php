<?php
/** $Id: l 2426 2006-11-18 19:59:26Z jrust $ */
// {{{ license
...
class HTML_ToPDF {
     ...
     * @var string
     */
    var $defaultDomain = 'gwserver/data';
	...
	//var $ps2pdfPath = '/gs/gs8.50/lib/ps2pdf';
     ...
     * @var array
     */
    var $headers = array('left' => '', 'right' => '');

    /**
     * The footer information
     * @var array
     */
    var $footers = array('center' => '');
     ...
     * @var bool
     */
    var $makeAbsoluteImageUrls = false;
    ...
    function convert()
    {
        ...
        $cmd = $this->ps2pdfPath . ' -sPAPERSIZE=' . $paperSize . ' -I' . $this->ps2pdfIncludePath . ' ' .
            ' -dAutoFilterColorImages=false -dColorImageFilter=/FlateEncode -dAutoRotatePages=/All ';
        if (OS_WINDOWS) {
    ...
    function _modifyConfFile()
    {
		...
		//echo "<p style=\"color:green\">ADDITIONAL CSS: <br>".$this->additionalCSS."</p>";
    ...
    function _getPaperSize()
    {
        ...
        preg_match('/@page.*?{.*?size\s*:\s*(.*?);/is', $this->html2psrc, $matches);
        if (!isset($matches[1])) {
