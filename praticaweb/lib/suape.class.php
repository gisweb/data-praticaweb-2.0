...
if (!defined(DATA_DIR)) define('DATA_DIR',dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR);
...
class suape{
    ...
    const dir = DATA_DIR."praticaweb".DIRECTORY_SEPARATOR."documenti".DIRECTORY_SEPARATOR."pe".DIRECTORY_SEPARATOR;
    const debugDir = DATA_DIR."praticaweb".DIRECTORY_SEPARATOR."debug".DIRECTORY_SEPARATOR;
