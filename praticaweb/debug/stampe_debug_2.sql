SELECT DISTINCT app,nominativo FROM stp.richiedenti WHERE pratica=8654
SELECT DISTINCT app,nominativo FROM stp.progettisti WHERE pratica=8654
SELECT DISTINCT presente,nome FROM stp.allegati_check WHERE pratica=8654
SELECT DISTINCT zona FROM stp.zone_prg WHERE pratica=8654
SELECT DISTINCT numero,tipo_intervento,oggetto FROM stp.avv_procedimento WHERE pratica=8654
SELECT DISTINCT zona FROM stp.zone_ptcpi WHERE pratica=8654
SELECT DISTINCT zona FROM stp.zone_ptcpg WHERE pratica=8654
SELECT DISTINCT zona FROM stp.zone_ptcpv WHERE pratica=8654
SELECT vincoli_paesistici FROM stp.vincoli_paesistici(8654);
SELECT vincoli_conformita FROM stp.vincoli_conformita(8654);
