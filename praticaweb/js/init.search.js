var colsDef={
    ...
    online:[[
        ...
        {title:'Data Pres.',sortable:true,field:'data_presentazione',width:80,styler: function(value,row,index){return 'font-size:11px;';}},
        {title:'Prot.',sortable:true,field:'protocollo',width:70,styler: function(value,row,index){return 'font-size:11px;';}},
